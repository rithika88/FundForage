...
export default function HomePage({ navigate }) {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const res = await campaignsAPI.getAll({ limit: 20, status: "active" });
  ...
  const stats = {
    ...
    raised: (campaigns || []).reduce((s, c) => s + (c.raisedAmount || 0), 0),
    ...
    <div className="home-page">
      ...
      <section className="hero">
        ...
        <div className="container hero-content">
          ...
          <p className="hero-subtitle">
            From deep-sea drones to urban farms — discover campaigns
            <br className="break-md" /> that are reshaping the world.
          </p>
      ...
      {!loading && filtered.length > 0 && (
        <section className="featured-section container">
          ...
          <CampaignCard campaign={filtered[0]} navigate={navigate} featured />
        </section>
      )}
